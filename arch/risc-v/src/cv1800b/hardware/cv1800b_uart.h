...
#  define CV1800B_UART0_TXCTRL  (CV1800B_UART0_BASE + UART_TXCTRL_OFFSET)
#  define CV1800B_UART0_RXCTRL  (CV1800B_UART0_BASE + UART_RXCTRL_OFFSET)
#  define CV1800B_UART0_IE      (CV1800B_UART0_BASE + UART_IE_OFFSET)
